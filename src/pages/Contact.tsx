  ...
  const contacts = [
    {
      ...
      value: "1900 6828",
      sub: "7:00 - 20:00 tất cả các ngày",
      href: "tel:19006828",
    },
    {
      icon: "email",
      label: "Email hỗ trợ",
      value: "support@agrisage.vn",
      sub: "Phản hồi trong vòng 2 giờ",
      href: "mailto:support@agrisage.vn",
    },
    {
      icon: "location_on",
      label: "Trung tâm điều hành",
      value: "Tòa nhà AgriTech, Khu CNC TP.HCM",
      sub: "Thứ 2 - Thứ 7: 8:00 - 17:30",
      href: "#",
    },
    {
      icon: "store",
      label: "Chi nhánh Lâm Đồng",
      value: "142 Hùng Vương, Di Linh, Lâm Đồng",
      sub: "Thứ 2 - CN: 7:00 - 20:00",
      href: "#",
    },
  ]
      ...
      <div className="bg-gradient-to-r from-primary-dark to-primary text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-3">
            Đội ngũ AgriSage luôn sẵn sàng hỗ trợ
          </h1>
          <p className="text-emerald-100/90 text-sm max-w-xl">
            Kỹ sư nông nghiệp và đội ngũ kỹ thuật của chúng tôi sẵn sàng tư vấn
            cho bạn từ 7 giờ sáng đến 8 giờ tối mỗi ngày.
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-4 space-y-4">
            {contacts.map((c) => (
              <a
                key={c.label}
                href={c.href}
                className="flex items-start gap-4 p-4 bg-white rounded-xl border border-border-subtle shadow-sm hover:shadow-md hover:border-primary transition-all group"
              >
            ...
            <div className="bg-primary rounded-xl p-4 text-white">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-bold">
                  Chat trực tuyến với kỹ sư
                </span>
              </div>
              <p className="text-xs text-emerald-100/90 mb-3">
                Kết nối ngay với kỹ sư nông nghiệp đang trực tuyến. Phản hồi
                trong dưới 2 phút.
              </p>
            ...
            <div className="bg-white rounded-xl border border-border-subtle shadow-sm p-4">
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <button
                    key={s.label}
                    className="flex-1 flex flex-col items-center gap-1 p-2 bg-surface-subtle rounded-lg hover:bg-primary-light hover:text-primary transition-colors text-xs font-medium text-text-secondary"
                  >
                    <span>{s.icon}</span>
                    <span>{s.label}</span>
                  </button>
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-6 bg-white rounded-2xl border border-border-subtle shadow-sm p-6">
              ...
              <div className="space-y-3">
                {[
                  {
                    q: "Làm thế nào để đặt hàng với số lượng lớn?",
                    a: "Liên hệ hotline 1900 6828 hoặc gửi email để được tư vấn giá đặc biệt và hỗ trợ hạn mức tín dụng cho đơn hàng lớn.",
                  },
                  {
                    q: "AgriSage có giao hàng toàn quốc không?",
                    a: "Có, chúng tôi giao hàng toàn quốc. Khu vực Tây Nguyên và ĐBSCL có dịch vụ giao tận vườn trong 2-4 giờ.",
                  },
                  {
                    q: "Bác sĩ AI có mất phí không?",
                    a: "Hoàn toàn miễn phí cho bà con nông dân. Bạn có thể sử dụng không giới hạn số lần chẩn đoán.",
                  },
                  {
                    q: "Làm thế nào để trở thành đại lý AgriSage?",
                    a: "Điền form đăng ký đại lý hoặc gọi hotline. Đội ngũ kinh doanh sẽ liên hệ trong vòng 24 giờ.",
                  },
                ].map((faq, i) => (
                  <details
                    key={i}
                    className="group border border-border-subtle rounded-lg"
                  >
