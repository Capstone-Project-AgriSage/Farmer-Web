          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-emerald-100/90 text-base sm:text-lg leading-relaxed max-w-2xl">
                Hệ sinh thái vật tư nông nghiệp chính hãng, bảo lãnh công nợ mùa
                vụ linh hoạt và trợ lý Trí tuệ Nhân tạo (AI) nhận diện bệnh hại
                cây trồng qua ảnh chụp tức thì.
              </p>
              <div className="pt-2">
                <form
                ...
                <div className="flex flex-wrap items-center gap-2 pt-3 text-xs text-emerald-100/80">
                  ...
                  {[
                    ...
                    <button
                      ...
                      onClick={() => {
                        setSearch(kw)
                        navigate(`/san-pham?q=${encodeURIComponent(kw)}`)
                      }}
                ...
                <div className="absolute bottom-20 left-4 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-lg border border-border-subtle flex items-center gap-2.5 text-text-primary">
                  ...
                  <div>
                    <div className="text-xs font-bold text-text-primary">
                      Giao vật tư tận vườn
                    </div>
                    <div className="text-[10px] text-text-muted">
                      Nhanh chóng trong 2-4h
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-8 space-y-4">
                ...
                <p className="text-text-secondary text-sm leading-relaxed max-w-2xl">
                  Không còn lo lắng cây trồng suy thoái. Chỉ cần chụp ảnh vùng
                  lá, cành hoặc rễ bị tổn thương, hệ thống AI của AgriSage sẽ
                  lập tức phân tích mầm bệnh và gợi ý đơn thuốc điều trị chuẩn
                  xác.
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-3">
                  {[
                    {
                      step: 1,
                      title: "Chụp ảnh cây trồng",
                      desc: "Chụp rõ nét vị trí lá đốm, cháy bìa hay rễ thối",
                    },
                    {
                      step: 2,
                      title: "AI phân tích mẫu",
                      desc: "Nhận diện chủng nấm, sâu bệnh hại và mức độ",
                    },
                    {
                      step: 3,
                      title: "Nhận phác đồ ngay",
                      desc: "Kê đơn thuốc chính xác & chỉ định cách phun",
                    },
                  ].map((s) => (
                    <div
                      key={s.step}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <Link
                key={cat.name}
                to={`/san-pham${cat.cat ? `?cat=${cat.cat}` : ""}`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featured.map((p) => (
              <div
                key={p.id}
                className="bg-white rounded-xl border border-border-subtle hover:border-primary hover:shadow-card transition-all duration-300 overflow-hidden flex flex-col justify-between group"
              >
                <Link
                  to={`/san-pham/${p.slug}`}
                  className="relative p-4 bg-white flex items-center justify-center h-48 overflow-hidden block"
                >
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t border-border-subtle mt-4 flex items-center justify-between">
                    ...
                    <button
                      onClick={() => handleAdd(p)}
                      className={`p-2 rounded-lg text-white shadow-sm transition-colors flex items-center justify-center ${
                        addedId === p.id
                          ? "bg-status-success"
          ...
          <div className="mt-8 text-center">
            <Link
              to="/san-pham"
              className="inline-flex items-center gap-2 px-8 py-3 bg-primary hover:bg-primary-hover text-white font-semibold rounded-lg transition-all shadow-sm"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto mb-10">
            ...
            <p className="text-sm sm:text-base text-text-secondary leading-relaxed">
              Chúng tôi luôn tâm niệm: không ngừng cải thiện chất lượng sản
              phẩm, để sản phẩm ngày càng tốt hơn. Đáp ứng tốt nhất nhu cầu cũng
              như tiêu chí: Năng suất - An toàn - Tiết Kiệm của bà con.
            </p>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 justify-items-center items-center max-w-6xl mx-auto">
            {[
              {
                img: "https://lh3.googleusercontent.com/aida/AEtjO1XgZ7DLtWlYgMhh9WINlbSPHx-PT5tCrn9siVvaQfzJS671Ur0e7bX6B3WOa0LNawIMRO5fcAm37JdZH-vnNjP7caTGFbkZxu5srBAQIL4O5f2JkxBhCwdocGbMvvnOstwKf-LYwf3zifftx0KOeRv3rw9Ke1dYKBwJ7L5rp4f1Upsgqu_Y1BgUpc0qO68vqIyLpAYMDuy4H68oUlHIGX83GBszJIEri0396SMHZLjf0RzBfpot0UtoEkI",
                label: "Tăng năng suất\nđạt 60-70%",
              },
              {
                img: "https://lh3.googleusercontent.com/aida/AEtjO1Uf9i7Tco-GWZVZdcp3f8hyddCRymsPSTL2ckJ8E6WBJIOVk8Y5COvQUuJ9ZGhWAQ5wQR9FESZmYMkRG13H7JJ3jBI7qhL-xO5O2JW32IRAR2xU7jIYIKp4zJXwJcoOl0MBpqqoen83yK19cKxarJP1kazufYjQjwQsuE_L28MypzBViCeJ1V9wMU5eHH3h0b3p2bEKSi-Rob57Lf98oPSRIiwCJWtFHndRofNRasNsoet9Zy3PHn5nqcM-",
                label: "Sản phẩm hữu cơ\nAn Toàn Tuyệt Đối",
              },
              {
                img: "https://lh3.googleusercontent.com/aida/AEtjO1VRA05tP7UFl5TbHAD5H5WgkbXGONH7EqnwUNe4AXW3nRN-wkqPaPHGIqPtQaDukH8pnqYXm2y6QMedDuBDLBRFUuDxl7mb8gTgLbu92Xo5Mu3fEQhwiL0Nt9TO7bfP9L80EigSGVd2R3gwADd6tVlfFxWarx8SI5U_8KC6e1AGgw1-T__AkapDsSJc7YJaYa7ni_724FMtl-C8tqYXRjOV43XfSRyoobG0s0X3RRd3TWe1KLmi5-hR4Q6A",
                label: "Tăng giá bán nông sản\n4-6 giá",
              },
              {
                img: "https://lh3.googleusercontent.com/aida/AEtjO1Wgs9o0X-zKJQ0fZzRAIifV_5oZW5aivn_HMJ6TLz0zdqmmynuxkX_9O_LL15KLj1E1yjBqbB5_nKfI63nFnqKQ4cc12tGdGvXikUq1_Qx7Rq-nSgpuu-YM2YO9TbGDXHBX0_dSUgWVukZRm-48sgGxZpTmdipzF4Nwws5rBLIdipO_IPR8La9oCGck6edVM7Uc9xsUS4edcdjjUtXBc43NY3Ei2YoPSg1GwmPOFtcRRboDaFCmrNz4PXE-",
                label: "Hỗ Trợ kỹ thuật\n24/7",
              },
            ].map((item) => (
              <div
                key={item.label}
                className="relative w-56 h-56 sm:w-60 sm:h-60 md:w-64 md:h-64 rounded-full overflow-hidden shadow-lg border-4 border-white group transition-transform duration-300 hover:scale-105"
              >
                <img
                  src={item.img}
                  alt={item.label}
                ...
                <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-black/85 via-black/50 to-transparent flex items-center justify-center text-center px-4 pb-2">
                  <span className="font-bold text-white text-base md:text-lg leading-snug drop-shadow-md text-center whitespace-pre-line">
                    {item.label}
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {latestArticles.map((a) => (
              <div
                key={a.id}
                className="bg-surface-subtle rounded-xl border border-border-subtle overflow-hidden hover:shadow-card transition-all group flex flex-col"
              >
                <Link
                  to={`/kien-thuc/${a.slug}`}
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    <div
                      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-semibold mb-3 ${categoryBadgeStyle(a.category)}`}
                    >
