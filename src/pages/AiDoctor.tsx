...
const mockDiagnoses: DiagnosisResult[] = [
  {
    ...
    confidence: 94,
    description:
      "Phát hiện bệnh thán thư do nấm Colletotrichum gloeosporioides gây ra. Vết bệnh trên lá có màu nâu đỏ, lan rộng theo hình tròn với quầng vàng bao quanh.",
    severity: "high",
    alternatives: [
    ...
    treatment:
      "Phun Ridomil Gold 68WG hoặc Nativo 750WG, cắt tỉa cành nhiễm bệnh và tiêu hủy. Phun 2-3 lần liên tiếp cách nhau 7-10 ngày. Tránh tưới nước lên tán lá.",
  },
  {
    disease: "Bệnh vàng lá do tuyến trùng",
    confidence: 87,
    description:
      "Phát hiện triệu chứng vàng lá do tuyến trùng Meloidogyne sp. tấn công bộ rễ. Rễ bị u bướu, suy giảm khả năng hấp thụ dinh dưỡng.",
    severity: "medium",
    alternatives: [
    ...
    treatment:
      "Tưới thuốc diệt tuyến trùng vào gốc, kết hợp bổ sung phân hữu cơ và nấm Trichoderma để phục hồi đất. Sử dụng King Root Humic để kích thích tái sinh bộ rễ.",
  },
  {
    disease: "Thiếu dinh dưỡng Kali (K)",
    confidence: 78,
    description:
      "Lá già xuất hiện vết vàng ở mép lá, sau khô cháy từ rìa vào trong. Đặc trưng của triệu chứng thiếu Kali trên cây trồng nhiệt đới.",
    severity: "low",
    alternatives: [
    ...
    treatment:
      "Bón bổ sung Kali Sulphate (SOP) 100-200g/gốc, chia 2-3 lần. Tưới đủ nước để cây hấp thụ dinh dưỡng. Phun phân bón lá chứa Kali để hỗ trợ nhanh.",
  },
]
...
export default function AiDoctor() {
  ...
  const recentCases = [
    ...
    {
      crop: "Tiêu",
      disease: "Chết nhanh Phytophthora",
      location: "Gia Lai",
      time: "32 phút trước",
    },
  ]
      ...
      <div className="bg-gradient-to-r from-primary-dark to-primary text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-emerald-100/90 text-sm sm:text-base max-w-2xl leading-relaxed">
            Chụp ảnh hoặc tải ảnh lá, cành, rễ bị bệnh. Hệ thống AI sẽ phân tích
            và đưa ra chẩn đoán cùng phác đồ điều trị trong vài giây.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-white rounded-2xl border border-border-subtle shadow-sm p-6">
              <h2 className="font-bold text-text-primary text-base mb-4">
                Tải ảnh cây trồng
              </h2>
                ...
                className={`relative border-2 border-dashed rounded-xl cursor-pointer transition-colors overflow-hidden ${
                  dragOver
                    ...
                    : preview
                      ...
                      : "border-border-strong hover:border-primary hover:bg-surface-subtle"
                }`}
              >
                {preview ? (
            ...
            {!result && !loading && (
              <div className="bg-white rounded-2xl border border-border-subtle shadow-sm h-full flex flex-col items-center justify-center p-12 text-center">
                ...
                <p className="text-sm text-text-muted max-w-xs">
                  Tải ảnh lên và nhấn "Phân tích bệnh ngay" để nhận kết quả chẩn
                  đoán từ AI.
                </p>
            ...
            {loading && (
              <div className="bg-white rounded-2xl border border-border-subtle shadow-sm h-full flex flex-col items-center justify-center p-12 text-center">
                ...
                <p className="text-sm text-text-muted">
                  Đang nhận diện mầm bệnh và so sánh với cơ sở dữ liệu 120+ bệnh
                  cây trồng
                </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl border border-border-subtle shadow-sm overflow-hidden">
                  <div className="p-5 border-b border-border-subtle flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-bold px-2.5 py-1 rounded-full ${confidenceBg(result.confidence)} ${confidenceText(result.confidence)}`}
                    >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                      {preview && (
                        <img
                          src={preview}
                          alt="Ảnh phân tích"
                          className="rounded-xl w-full h-48 object-cover border border-border-subtle"
                        />
                      )}
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="h-3 bg-surface-secondary rounded-full overflow-hidden">
                            <div
                              className={`h-full rounded-full transition-all duration-1000 ${confidenceColor(result.confidence)}`}
                              style={{ width: `${result.confidence}%` }}
                            />
                          </div>
                          <div
                            className={`text-xs font-bold mt-1 ${confidenceText(result.confidence)}`}
                          >
                            {result.confidence}%
                          </div>
                        </div>
                        ...
                        >
                          ...
                          {result.severity === "high"
                            ...
                            : result.severity === "medium"
                              ? "Trung bình - Theo dõi và điều trị"
                              : "Nhẹ - Phòng ngừa kịp thời"}
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white rounded-2xl border border-border-subtle shadow-sm p-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h3 className="font-bold text-text-primary">
                      Sản phẩm điều trị được đề xuất
                    </h3>
                  </div>
                  <div className="space-y-3">
                    {result.recommendedProducts.map((pid) => {
                      ...
                      return (
                        <div
                          key={pid}
                          className="flex items-center gap-3 p-3 bg-surface-subtle rounded-xl border border-border-subtle"
                        >
                          <img
                            src={p.image}
                            alt={p.name}
                            className="w-14 h-14 object-contain bg-white rounded-lg border border-border-subtle p-1"
                          />
                          <div className="flex-1 min-w-0">
                            ...
                            <Link
                              to={`/san-pham/${p.slug}`}
                              className="text-sm font-bold text-text-primary hover:text-primary line-clamp-1"
                            >
                              {p.name}
                            </Link>
                          ...
                          >
                            <span className="material-symbols-outlined text-[18px]">
                              {addedId === pid ? "check" : "add_shopping_cart"}
                            </span>
                          </button>
                        </div>
                      )
                ...
                <div className="bg-status-info-surface rounded-xl p-4 border border-blue-200 flex gap-3">
                  <span className="material-symbols-outlined text-[20px] text-status-info flex-shrink-0 mt-0.5">
                    info
                  </span>
                  <p className="text-xs text-status-info leading-relaxed">
                    <strong>Lưu ý quan trọng:</strong> Kết quả AI chỉ mang tính
                    tham khảo, không thay thế hoàn toàn tư vấn của kỹ sư nông
                    nghiệp có chứng chỉ. Trong trường hợp bệnh nghiêm trọng hoặc
                    có độ tin cậy &lt;70%, vui lòng liên hệ đường dây tư vấn{" "}
                    <strong>1900 6828</strong> để được hỗ trợ trực tiếp.
                  </p>
                </div>
