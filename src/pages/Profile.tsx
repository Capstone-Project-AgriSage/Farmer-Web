...
const ledgerRows = [
  [
    "18/10/2024",
    "#SN-2024-884",
    "Mua chịu vật tư NPK Đầu Trâu + Humic",
    "+ 2.215.000 đ",
    "48.500.000 đ",
    "Đã xác nhận HTX",
  ],
  ...
  [
    "22/09/2024",
    "#SN-2024-741",
    "Mua thuốc BVTV Ridomil Gold & Nativo 750WG",
    "+ 4.800.000 đ",
    "61.285.000 đ",
    "Đã ký điện tử",
  ],
  [
    "10/08/2024",
    "#SN-2024-602",
    "Mua đợt phân bón đón hoa sầu riêng",
    "+ 18.500.000 đ",
    "56.485.000 đ",
    "Đã ký điện tử",
  ],
...
const orders = [
  {
    ...
    date: "18/10/2024",
    title:
      "Đầu Trâu NPK 20-20-15+TE Nuôi Trái (2 bao) + Kích rễ Humic King Root 1L (3 chai)",
  ...
  },
  {
    ...
    date: "22/09/2024",
    title:
      "Thuốc Đặc Trị Nấm Bệnh Ridomil Gold 68WG Syngenta (10 gói) + Nativo 750WG",
...
function MetricCard({
  ...
  return (
    <div className="rounded-xl border border-border-subtle bg-white p-5 shadow-sm">
      ...
      <div className="mt-3 rounded-md bg-primary-light px-3 py-1.5 text-xs font-semibold text-primary">
        {note}
      </div>
    </div>
  )
...
export default function Profile() {
  ...
  const [activeTab, setActiveTab] =
    useState<"overview" | "credit" | "orders" | "ai">("credit")
            ...
            <div className="flex items-center gap-5">
              <div className="relative">
                <img
                  src={user.avatar}
                  alt={user.name}
                  className="h-24 w-24 rounded-xl border border-border-subtle object-cover shadow-sm"
                />
              ...
              <div>
                <div className="flex flex-wrap items-center gap-3">
                  <h1 className="text-2xl font-black text-text-primary">
                    Nguyễn Văn Đức (Bác Ba Đức)
                  </h1>
                  <span className="rounded-md border border-border-subtle bg-surface-subtle px-3 py-1 text-[11px] font-bold text-text-secondary">
                    #ND-84926
                  </span>
                  <span className="rounded-full border border-amber-300 bg-amber-50 px-3 py-1 text-[11px] font-bold text-amber-700">
                    Nông hộ liên kết Vàng - HTX Di Linh
                  </span>
                </div>
                <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2 text-sm text-text-secondary">
                  ...
                  <span className="flex items-center gap-1.5">
                    ...
                    Quy mô: 3.2 ha (Sầu riêng Ri6 & Cà phê Catimor)
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="material-symbols-outlined text-[16px] text-primary">
                      location_on
                    </span>
                    Thôn 4, xã Đinh Trang Hòa, huyện Di Linh, tỉnh Lâm Đồng
                  </span>
                </div>
              </div>
            </div>
        ...
        <nav className="mt-6 grid grid-cols-2 gap-2 border-b border-border-subtle text-sm font-bold text-text-muted md:flex md:gap-8">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 border-b-2 px-2 py-3 text-left transition-colors ${
                activeTab === tab
          ...
          <section className="mt-7 space-y-6">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
              <MetricCard
                ...
                value="3.2 ha"
                note="Sầu riêng Ri6 & Cà phê Catimor"
                icon="yard"
                accent="text-text-primary"
              />
              <MetricCard
                label="Nông hộ liên kết"
                value="Vàng"
                note="HTX Di Linh xác minh hồ sơ"
                icon="verified_user"
              />
              <MetricCard
                label="Sức khỏe vườn gần nhất"
                value="95%"
                note="AI đánh giá phục hồi tốt"
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2">
                {[
                  ...
                  <div key={label} className="rounded-lg bg-surface-subtle p-4">
                    ...
                    <div className="mt-2 font-black text-text-primary">
                      {value}
                    </div>
                  </div>
                ))}
        ...
        {activeTab === "credit" && (
          <>
            <section className="mt-7">
              <div className="mb-4 flex flex-col justify-between gap-3 md:flex-row md:items-end">
                <div>
                  ...
                  <p className="mt-1 text-sm text-text-muted">
                    Chương trình liên kết Đại lý Di Linh & HTX Nông nghiệp: Cung
                    cấp vật tư trước, quyết toán sau vụ thu hoạch.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                <MetricCard
                  label="Hạn mức tín dụng mùa vụ"
                  value="100.000.000 đ"
                  note="Lãi suất 0% bảo lãnh vụ mùa"
                  icon="shield"
                  accent="text-text-primary"
                />
                <MetricCard
                  label="Dư nợ tạm tính hiện tại"
                  value="48.500.000 đ"
                  note="Tỷ lệ an toàn 48.5%"
                  icon="request_quote"
                  accent="text-amber-600"
                />
                <MetricCard
                  label="Hạn mức có thể mua tiếp"
                  value="51.500.000 đ"
                  note="Thời hạn quyết toán: 30/12/2024"
              ...
              <div className="mt-5 rounded-xl border border-border-subtle bg-white p-5 shadow-sm">
                <div className="mb-2 flex justify-between text-xs font-bold text-text-secondary">
                  ...
                  <span>
                    Đã giải ngân:{" "}
                    <strong className="text-amber-600">48.500.000 đ</strong> /
                    100.000.000 đ
                  </span>
                </div>
              ...
              <div className="mb-5 flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-text-muted">
                    Mọi biến động giao dịch vật tư và trả góp đều được ký điện
                    tử lưu vết với HTX.
                  </p>
                </div>
                  ...
                  <thead className="border-y border-border-subtle bg-surface-subtle text-text-muted">
                    <tr>
                      {[
                        "Ngày giao dịch",
                        "Mã chứng từ / đơn",
                        "Loại giao dịch & nội dung vật tư",
                        "Biến động nợ",
                        "Dư nợ sau giao dịch",
                        "Trạng thái",
                      ].map((h) => (
                        ...
                        {row.map((cell, index) => (
                          <td
                            ...
                            className={`px-3 py-4 ${
                              ...
                              index === 4 ? "font-black text-text-primary" : ""
                            }`}
                          >
                            {index === 5 ? (
                              <span className="rounded-full bg-emerald-50 px-3 py-1 font-bold text-primary">
                                {cell}
                              </span>
                            ) : (
                              cell
              ...
              {orders.map((order) => (
                ...
                >
                  <div className="mb-4 flex flex-wrap items-center justify-between gap-2 border-b border-border-subtle pb-3 text-xs text-text-muted">
                    <span className="rounded bg-surface-subtle px-2 py-1 font-bold text-text-secondary">
                      Mã đơn: {order.code}
                    </span>
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center">
                    <img
                      src={order.image}
                      alt={order.title}
                      className="h-16 w-16 rounded-lg border border-border-subtle object-contain p-2"
                    />
                    ...
                    <button className="rounded-lg border border-border-subtle px-4 py-2 text-sm font-bold text-text-secondary">
                      Chi tiết
                    </button>
                  </div>
                </article>
          ...
          <section className="mt-7 rounded-xl border border-border-subtle bg-white p-5 shadow-sm">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-xs text-text-muted">
                  Hệ thống theo dõi sức khỏe cây sầu riêng và cà phê quanh lô
                  định kỳ.
                </p>
              </div>
              <Link
            ...
            <div className="flex flex-col gap-4 rounded-lg border border-border-subtle bg-surface-subtle p-4 md:flex-row md:items-center">
              <img
                src="https://lh3.googleusercontent.com/aida/AEtjO1X4PNGtFdGdTKuP_q5b4AxicP1QuZ5rEfbRjSKcjG2Cau2keKYL7yK6vxf3bWj4B7RBcVkEYhAnX19LtgqmiRIJnkcPEYgL6UjJDWzBVEqxCesa9A3M6R-zplqVJ_ZSgDC1N3HrzfOouUsYU6BOv43eC6pPG6ldp0OYrMnWWA2AdI2Z83DoW7pyWDjoBjC9KQ7GJ4jBuJC8_nyE9ElFzykX9Pj4_KAJ5qTFPXbPpvFNMQFrvw934RML9tGd"
                alt="Vườn sầu riêng"
                className="h-24 w-24 rounded-lg object-cover"
              />
              <div className="flex-1">
                <div className="text-xs font-bold text-text-muted">
                  Ca quét ngày 12/10/2024
                </div>
                <h3 className="mt-1 font-black text-text-primary">
                  Kết quả: Bệnh Đốm Mắt Cua (Thán thư lá non)
                </h3>
                <p className="mt-1 text-xs text-text-secondary">
                  Phác đồ đã thực hiện: Phun Score 250EC kết hợp Humic dưỡng
                  đọt. Trạng thái hiện tại: Cây đã phục hồi hoàn toàn.
                </p>
              </div>
              ...
              <Link
                to="/bac-si-ai"
                className="rounded-lg border border-border-subtle bg-white px-4 py-2 text-sm font-bold text-primary"
              >
          ...
          <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-border-subtle bg-white shadow-floating">
            <div className="flex items-center justify-between border-b border-border-subtle px-6 py-4">
              <div>
                ...
                <p className="mt-1 text-xs text-text-muted">
                  Cập nhật thông tin liên hệ, địa chỉ vườn và quy mô canh tác.
                </p>
              </div>
              <button
                type="button"
            ...
            <div className="max-h-[70vh] overflow-y-auto px-6 py-5">
              <div className="mb-5 flex items-center gap-4 rounded-xl bg-primary-light/60 p-4">
                ...
                <button
                  type="button"
                  className="ml-auto rounded-lg border border-border-subtle bg-white px-3 py-2 text-xs font-bold text-primary hover:bg-primary-light"
                >
                  Đổi ảnh
                </button>
              </div>
