        ...
        <div className="hidden lg:flex flex-col bg-gradient-to-b from-primary-dark to-primary text-white p-10 relative overflow-hidden">
          ...
          <div className="flex-1 flex flex-col justify-center relative z-10">
            ...
            <p className="text-emerald-100/90 text-sm leading-relaxed mb-8">
              Đăng nhập để truy cập đầy đủ tính năng: Đặt hàng, Quản lý nợ vụ và
              Bác sĩ cây trồng AI.
            </p>
            ...
            <div className="space-y-4">
              {[
                {
                  icon: "shopping_bag",
                  title: "Đặt hàng & Quản lý",
                  desc: "Theo dõi đơn hàng, lịch sử mua và hạn mức tín dụng",
                },
                {
                  icon: "psychology",
                  title: "Bác sĩ cây trồng AI",
                  desc: "Chẩn đoán bệnh không giới hạn, lưu kết quả lâu dài",
                },
                {
                  icon: "notifications",
                  title: "Cảnh báo dịch hại vùng",
                  desc: "Nhận thông báo kịp thời về dịch bệnh khu vực của bạn",
                },
              ].map((f) => (
          ...
          {tab === "login" ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 bg-primary hover:bg-primary-hover text-white rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="py-2.5 border border-border-subtle rounded-lg text-sm font-semibold text-text-secondary hover:bg-surface-subtle flex items-center justify-center gap-2 transition-colors"
                >
                  <span>🇬 Google</span>
                </button>
                <button
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    { key: "farmer", label: "Nông dân", icon: "agriculture" },
                    {
                      key: "dealer",
                    ...
                    >
                      <input
                        ...
                        name="role"
                        value={r.key}
                        checked={regForm.role === r.key}
                        onChange={() => setRegForm({ ...regForm, role: r.key })}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-border-subtle rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-primary"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-3 pr-10 py-2.5 border border-border-subtle rounded-lg text-sm focus:outline-none focus:border-primary"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRegForm({ ...regForm, confirmPass: e.target.value })
                    }
                    className="w-full px-3 py-2.5 border border-border-subtle rounded-lg text-sm focus:outline-none focus:border-primary"
              ...
              <label className="flex items-start gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    setRegForm({ ...regForm, agree: e.target.checked })
                  }
