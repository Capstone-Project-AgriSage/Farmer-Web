        ...
        {sent ? (
          <div className="text-center">
            <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-full bg-status-success-surface">
              <span className="material-symbols-outlined text-[30px] text-status-success">
                mark_email_read
              </span>
            </div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-text-secondary">
              Vui lòng kiểm tra email hoặc tin nhắn liên kết với tài khoản của
              bạn. Liên kết đặt lại mật khẩu sẽ hết hạn sau 15 phút.
            </p>
            <Link
              to="/dang-nhap"
          ...
          <>
            ...
            <p className="mt-2 text-sm leading-relaxed text-text-secondary">
              Nhập email hoặc số điện thoại đã đăng ký, AgriSage sẽ gửi hướng
              dẫn đặt lại mật khẩu cho bạn.
            </p>
            ...
            <Link
              to="/dang-nhap"
              className="mt-5 flex items-center justify-center gap-1 text-sm font-semibold text-primary hover:underline"
            >
